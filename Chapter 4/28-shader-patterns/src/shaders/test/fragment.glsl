...
void main()
{
    ...
    // vec2 rotatedUV = rotate(vUv, PI * 0.25, vec2(.5));
    ...
    // float strength = 1.0 - step(0.01, abs(distance(waveUV, vec2(.5)) - .25));
    
    // vec2 waveUV = vec2(vUv.x + sin(vUv.y * 100.0) * 0.1, vUv.y + sin(vUv.x * 100.0) * 0.1);
    // float strength = 1.0 - step(0.01, abs(distance(waveUV, vec2(.5)) - .25));

    // float angle = atan(vUv.x - 0.5, vUv.y - 0.5) / (PI * 2.0) + .5;
    // float sinusoid = sin(angle * 100.0);

    // float radius = 0.25 + sinusoid * 0.02;
    // float cirlce = 1.0 - step(0.01, abs(distance(vUv, vec2(.5)) - radius));
