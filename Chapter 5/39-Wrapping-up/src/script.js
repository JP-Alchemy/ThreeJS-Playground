...
// const portalLightMaterial = new THREE.MeshBasicMaterial({ color: 0xC8F5FF })
debugObject.portalColorStart = '#000000'
debugObject.portalColorEnd = '#ebfbff'
...
gltfLoader.load('/models/Portal.glb', (gltf) => {
    ...
    const poleLightMesh = gltf.scene.children.find((child) => child.name === 'Lamp')
